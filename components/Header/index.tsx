...
const Header = () => {
  ...
  return (
    <header
      id="site-header"
      className={`fixed left-0 top-0 z-99999 w-full py-7 border border-stroke ${
        stickyMenu
    ...
    >
      <div className="relative mx-auto items-center justify-between ml-auto px-8 flex ">
        ...
        >
          <nav>
            <ul className="flex flex-col gap-5 xl:flex-row xl:items-center font-semibold xl:gap-10">
