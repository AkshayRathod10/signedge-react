            ...
            >
              ...
              <div className="mb-7.5 flex flex-col gap-5">
                <div className="flex items-start gap-3">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6.62 10.79a15.46 15.46 0 006.59 6.59l2.2-2.2a1 1 0 011.02-.24 11.36 11.36 0 003.56.57 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.36 11.36 0 00.57 3.56 1 1 0 01-.24 1.02l-2.2 2.21z" fill="currentColor"/>
                    </svg>
                  </span>
                  <p className="flex flex-col gap-1">
                    <a href="tel:9833035262" className="hover:text-primary">+91 9833035262</a>
                    <a href="tel:9667667826" className="hover:text-primary">+91 9667667826</a>
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1zm8 7L4.5 6h15L12 11zm0 2.2L4 7.7V18h16V7.7l-8 5.5z" fill="currentColor"/>
                    </svg>
                  </span>
                  <a href="mailto:info@signedgeindia.com" className="hover:text-primary">
              ...
              <div className="mb-7.5">
                ...
                <p>A-432, 2nd Floor, Vashi Plaza, Vashi, Navi Mumbai - 400703</p>
              </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-7.5">
                  ...
                  />
                  {errors.captcha && (
                    <div className="mt-1 text-sm text-red-500">{errors.captcha}</div>
                  )}
                </div>
